...
const Aside = ({ sidebarActive, mobileMenu, mobileMenuControl }) => {
  ...
  // For admin: show all stores from API, for manager: show only stores from session
  const { stores, isLoading: storesLoading } = useStores({
    filterByUserStores: false, // Don't filter - admin gets all, manager gets session stores directly
    useSessionStores: isManager, // Manager uses stores from session, admin fetches all from API
    enabled: !sessionLoading, // Wait for session to load before fetching
  });
        ...
        <ul className="sidebar-menu" id="sidebar-menu">
          <li className="dropdown">
            ...
            <ul className="sidebar-submenu">
              {/* Show Main Dashboard only for admin */}
              {isAdmin && (
                <li>
                  <Link
                    href="/"
                ...
                stores.map((store) => (
                  <li key={store.id}>
                    <Link
                      ...
                      className={
                        pathname === `/store/${store.slug || store.id}`
                          ? "active-page"
                          : ""
                      }
                    >
            ...
            <>
              ...
              <li>
                <Link
                  ...
                  className={
                    pathname === "/store-comparison" ? "active-page" : ""
                  }
                >
                  <Icon icon="solar:graph-up-bold" className="menu-icon" />
              ...
              <li>
                ...
                >
                  <Icon icon="solar:shop-2-bold" className="menu-icon" />
                  <span>Stores</span>
                </Link>
              </li>
              <li>
                ...
                >
                  <Icon icon="lucide:folder" className="menu-icon" />
              ...
              <li>
                ...
                >
                  <Icon icon="lucide:user-circle" className="menu-icon" />
                  <span>Employees</span>
                </Link>
              </li>
              <li>
          ...
          {/* <li className="dropdown">
            ...
            <ul className="sidebar-submenu">
              ...
              <li>
                <Link
                  href="/image-upload"
                  className={pathname === "/image-upload" ? "active-page" : ""}
                >
                  <i className="ri-circle-fill circle-icon text-primary-600 w-auto" />{" "}
                  Upload
                </Link>
